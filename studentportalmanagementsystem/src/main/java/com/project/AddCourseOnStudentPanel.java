...
/**
 * A GUI class for adding courses on the student panel.
 */
public class AddCourseOnStudentPanel extends JFrame {
    // Components
    JLabel l1, l2, l3;
    JTextField t1, t2, t3;
    JButton b1, b2;
     ...
     */
    public AddCourseOnStudentPanel() {
        // Frame settings
    ...
    class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Submit")) {
                ...
                Course c1 = new Course(b, a, c);
                c1.saveDataToFile(c1);
            } else if (e.getActionCommand().equals("Home")) {
                // Dispose the current frame and open the StudentPanel
                dispose();
                new StudentPanel();
            }
        }
